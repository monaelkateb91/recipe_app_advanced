    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              subtitle: FutureBuilder(
                  ...
                  builder: (context, snapShot) {
                    if (snapShot.connectionState == ConnectionState.waiting) {
                      ...
                      var userIngredients = List<Ingredients>.from(snapShot
                          .data!.docs
                          .map((e) => Ingredients.fromJson(e.data(), e.id))
                          .toList());
          ...
          Text('Directions', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
          SizedBox(height: 300,

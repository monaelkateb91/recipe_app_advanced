...
class RecentlyCard extends StatefulWidget {
  final Recipe? recipe;
  const RecentlyCard({required this.recipe,super.key});
...
class _RecentlyCardState extends State<RecentlyCard> {
  ...
  Widget build(BuildContext context) {
    ...
    child: IconButton(
    onPressed: () {
    Provider.of<RecipesProvider>(context, listen: false).removeRecipeToUserRecentlyViewed(widget.recipe!.docId!);
